      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <div className="flex items-center gap-6">
            <a
              href="#"
              className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-slate-400 hover:border-brand-gold hover:text-brand-gold transition-all"
            >
          ...
          <p className="text-slate-600 text-xs font-medium">
            &copy; 2024 Sigue Adelante Radio. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
